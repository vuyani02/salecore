...
import type { IActivitiesStateContext, IActivity, IActivityPagedResult } from "./context";
...
export const getActivitiesSuccess = createAction<IActivitiesStateContext, IActivityPagedResult>(ActivitiesActionEnums.getActivitiesSuccess, (activities) => ({ isPending: false, isSuccess: true,  isError: false, activities }));
...
export const getActivitySuccess = createAction<IActivitiesStateContext, IActivity>(ActivitiesActionEnums.getActivitySuccess, (activity) => ({ isPending: false, isSuccess: true,  isError: false, activity }));
...
export const getMyActivitiesSuccess = createAction<IActivitiesStateContext, IActivityPagedResult>(ActivitiesActionEnums.getMyActivitiesSuccess, (myActivities) => ({ isPending: false, isSuccess: true,  isError: false, myActivities }));
...
export const getUpcomingSuccess = createAction<IActivitiesStateContext, IActivityPagedResult>(ActivitiesActionEnums.getUpcomingSuccess, (upcomingActivities) => ({ isPending: false, isSuccess: true,  isError: false, upcomingActivities }));
...
export const getOverdueSuccess = createAction<IActivitiesStateContext, IActivityPagedResult>(ActivitiesActionEnums.getOverdueSuccess, (overdueActivities) => ({ isPending: false, isSuccess: true,  isError: false, overdueActivities }));
...
export const createActivitySuccess = createAction<IActivitiesStateContext, IActivity>(ActivitiesActionEnums.createActivitySuccess, (createdActivity) => ({ isPending: false, isSuccess: true,  isError: false, createdActivity }));
...
export const updateActivitySuccess = createAction<IActivitiesStateContext, IActivity>(ActivitiesActionEnums.updateActivitySuccess, (updatedActivity) => ({ isPending: false, isSuccess: true,  isError: false, updatedActivity }));
...
export const completeActivitySuccess = createAction<IActivitiesStateContext, IActivity>(ActivitiesActionEnums.completeActivitySuccess, (updatedActivity) => ({ isPending: false, isSuccess: true,  isError: false, updatedActivity }));
...
export const cancelActivitySuccess = createAction<IActivitiesStateContext, IActivity>(ActivitiesActionEnums.cancelActivitySuccess, (updatedActivity) => ({ isPending: false, isSuccess: true,  isError: false, updatedActivity }));
